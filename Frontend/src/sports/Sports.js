...
// Utility to create a custom DivIcon for each match
function createMatchIcon(homeTeam, awayTeam) {
  ...
  return new DivIcon({
    html,
    className: '', // disables leaflet default styles
    iconAnchor: [40, 22] // Center bottom for better alignment
  });
}

// Helper: Detects Arabic
...
export default function Sports() {
  ...
  // Only fetch news when switching to news
  useEffect(() => {
  ...
  return (
    <div className="sports-section">
      ...
      {/* TABLE & ROUND SELECTOR */}
      <div className="sports-table">
        {/* Tabs */}
        <div className="sports-tabs" style={{ display: 'flex', justifyContent: 'center', gap: '2rem', marginBottom: '1rem' }}>
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              border: 'none',
              borderBottom: view === 'results' ? '3px solid #1976d2' : '3px solid transparent',
              background: 'transparent',
              color: view === 'results' ? '#1976d2' : '#444',
              fontSize: '1.15rem',
              cursor: 'pointer'
            }}
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              border: 'none',
              borderBottom: view === 'news' ? '3px solid #1976d2' : '3px solid transparent',
              background: 'transparent',
              color: view === 'news' ? '#1976d2' : '#444',
              fontSize: '1.15rem',
              cursor: 'pointer'
            }}
        ...
        {view === 'results' ? (
          <>
            <div className="round-selector" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', marginBottom: '1rem' }}>
              <select
                id="round-select"
                value={selectedRound}
          ...
          <div className="news-list" style={{ maxHeight: '100%', overflowY: 'auto' }}>
            {news.length === 0 ? (
